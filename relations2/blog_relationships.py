...
# Notice that we set author=alice directly on the Post object, and tags=[python_tag, tutorial_tag] as a list. SQLAlchemy handles inserting the foreign keys and association table rows.

# Step 3: Navigate one-to-many relationships
with Session(engine) as session:
...
# === Authors and Their Posts ===
  ...
  # Bob Martinez (1 posts):
    # - Python for Data Science

# === Post Authors ===
  # 'Getting Started with Python' by Alice Park
  # 'SQL Joins Explained' by Alice Park
  # 'Python for Data Science' by Bob Martinez
...
# You should see:
# === Posts and Tags ===
  # 'Getting Started with Python': python, tutorial, beginner
  # 'SQL Joins Explained': sql, tutorial
  # 'Python for Data Science': python

# === Tags and Their Posts ===
  # python: Getting Started with Python, Python for Data Science
  # sql: SQL Joins Explained
  # tutorial: Getting Started with Python, SQL Joins Explained
  # beginner: Getting Started with Python

# Both directions work: post.tags gives you the tags on a post, and tag.posts gives you all posts with that tag.
...
# Adding a tag is as simple as appending to a Python list. SQLAlchemy handles the INSERT into the association table.